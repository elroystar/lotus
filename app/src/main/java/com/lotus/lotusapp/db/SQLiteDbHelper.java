...
public class SQLiteDbHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_WASH_PRICE = "wash_price";
    // 创建 user 表的 sql 语句
    ...
    private static final String WASH_PRICE_CREATE_TABLE_SQL = "create table " + TABLE_WASH_PRICE + "("
            + "id integer primary key autoincrement,"
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // 创建 wash_price 表
        db.execSQL(WASH_PRICE_CREATE_TABLE_SQL);
        // 添加默认密码规则
